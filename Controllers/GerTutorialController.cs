...
{
  public class GerTutorialController : Controller
  {
    private readonly IValidateSession _validateSession;
    private readonly IConfiguration _configuration;
    private readonly IWebHostEnvironment _webHostEnvironment;
    private readonly IFileEncryptor _fileEncryptor;
    public GerTutorialController(IValidateSession validateSession, IConfiguration configuration, IWebHostEnvironment webHostEnvironment, IFileEncryptor fileEncryptor)
    {
    ...
    public async Task<IActionResult> GerTutorial()
    {
      ...
      try
      {
        ...
        return View("GerTutorial", partialModel);
      }
      catch
      {
